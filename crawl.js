      ...
      case 0:
        ...
        .each((j,e) => {
          if(j === 0) {
            ...
            .each((k,element) => {
              let part = []
              part.push($(element).text().replace(/↵/g, "").replace(/\s+/g," "))
        ...
        break;
      case 1:
        $(ele).children().each((a,q) => playerDetail.bling.push($(q).text()))
        break;
      case 2: break;
      case 3: break;
      case 4:
        $(ele)
        .children()
        .each((a,c) => $(c).children().each((q,w) => $(w).children().each((e,r) => console.log($(r).text()))))
        break;
      default: break;
    }
  })
